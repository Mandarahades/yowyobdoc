...
export default function indices({}: Props) {
  return (
        ...
        <div className='flex flex-row md:flex-col md:px-2 my- md:my-0 md:py-0  h-10 md:w-24 md:max-h-screen md:mx-2 md:items-start md:justify-start text-white shrink-1'>
              <div className='flex flex-row md:flex-col w-1/5 md:w-full   bg-gray-900 opacity-80 items-center justify-center p-2 rounded-full mr-5 md:mr-1'>
              ...
              <div className='flex flex-row md:flex-col w-2/5 md:w-full h-15 md:h-60 bg-gray-900 opacity-80 items-center justify-center p-2 rounded-full md:mr-1 md:mb-2 md:mt-8 flex-shrink-1'>
              ...
              <div className='flex flex-row md:flex-col w-2/5 md:w-full h-15 md:h-64  bg-gray-900 opacity-80 items-center justify-center p-2 rounded-full mr-1 md:mb-8 '>
                  <div className='flex flex-col items-center md:mb-2'>
              ...
              <div className="md:mx-2 p-2 md:px-2 flex flex-col justify-center items-center self-end md:bottom-auto md:w-full bg-gray-900 rounded-full">
