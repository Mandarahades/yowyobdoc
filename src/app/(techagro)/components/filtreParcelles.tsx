...
export default function filtreParcelles({}: Props) {
  return (
    <div className="flex flex-row  justify-center border border-white rounded-2xl mt-2">
      <div className='text-green-500 flex flex-col items-center justify-center mr-2 ml-2'>Filtrer</div>
      <form className=' form flex flex-grow w-8/12 text-white justify-center items-center'>
