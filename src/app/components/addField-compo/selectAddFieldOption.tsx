...
<dialog id="my_modal_3" className="modal">
  <div className="modal-box">
    ...
    <div className='flex flex-col'>
        ...
        <div className='flex flex-col items-center md:flex-row p-1'>
            <div className='flex flex-col justify-center items-center border w-full bg-slate-400 md:h-96 md:w-1/2 m-2 p-2'>
                <div className='flex flex-col  md:h-full'>
                    ...
                    <label htmlFor="file-upload" className='flex flex-col text-white btn bg-green-500 md:mt-7 mt-4'>
                     SELECTIONER UN FICHIER
                    </label>
                    <input
                        id="file-upload"
                        type="file"
                        accept=".txt,.pdf,.doc,.docx" // Types de fichiers acceptés (optionnel)
                        style={{ display: 'none' }} // Cacher l'élément input
                        onChange={handleFileUpload} // Gérer le changement de fichier sélectionné
                    />
                </div>
        ...
        Si quelque chose ne va pas, veuillez <Link className = 'link link-hover link-primary' href={"/contact"} >nous contacter</Link>
        </p>
    </div>
